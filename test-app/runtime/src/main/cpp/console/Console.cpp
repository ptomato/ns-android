...
void Console::sendToDevToolsFrontEnd(v8::Isolate* isolate, const std::string& method, const v8::FunctionCallbackInfo<v8::Value>& args) {
    if (!m_callback) {
        return;
    }
...
void Console::sendToDevToolsFrontEnd(v8::Isolate* isolate, const std::string& method, const std::string& message) {
    if (!m_callback) {
        return;
    }
...
void Console::assertCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
    try {
        ...
        if (!expressionPasses) {
            ...
            sendToDevToolsFrontEnd(isolate, ConsoleMethod::ASSERT, info);
        }
...
void Console::errorCallback(const v8::FunctionCallbackInfo <v8::Value>& info) {
    try {
        ...
        sendToADBLogcat(log, ANDROID_LOG_ERROR);
        sendToDevToolsFrontEnd(info.GetIsolate(), ConsoleMethod::ERROR, info);
    } catch (NativeScriptException& e) {
        e.ReThrowToV8();
    } catch (std::exception e) {
        std::stringstream ss;
...
void Console::infoCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
    try {
        ...
        sendToDevToolsFrontEnd(info.GetIsolate(), ConsoleMethod::INFO, info);
    } catch (NativeScriptException& e) {
        e.ReThrowToV8();
    } catch (std::exception e) {
        std::stringstream ss;
...
void Console::logCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
    try {
        ...
        sendToADBLogcat(log, ANDROID_LOG_INFO);
        sendToDevToolsFrontEnd(info.GetIsolate(), ConsoleMethod::LOG, info);
    } catch (NativeScriptException& e) {
        e.ReThrowToV8();
    } catch (std::exception e) {
        std::stringstream ss;
...
void Console::warnCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
    try {
        ...
        sendToDevToolsFrontEnd(info.GetIsolate(), ConsoleMethod::WARNING, info);
    } catch (NativeScriptException& e) {
        e.ReThrowToV8();
    } catch (std::exception e) {
        std::stringstream ss;
...
void Console::dirCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
    try {
        ...
        sendToADBLogcat(log, ANDROID_LOG_INFO);
        sendToDevToolsFrontEnd(isolate, ConsoleMethod::DIR, info);
    } catch (NativeScriptException& e) {
        e.ReThrowToV8();
    } catch (std::exception e) {
        std::stringstream ss;
...
void Console::traceCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
    try {
        ...
        sendToDevToolsFrontEnd(isolate, ConsoleMethod::TRACE, info);
    } catch (NativeScriptException& e) {
        e.ReThrowToV8();
    } catch (std::exception e) {
        std::stringstream ss;
...
void Console::timeEndCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
    try {
        ...
        if (itTimersMap == timersMap.end()) {
            ...
            sendToDevToolsFrontEnd(isolate, ConsoleMethod::WARNING, warning);
        ...
        sendToDevToolsFrontEnd(isolate, ConsoleMethod::TIME_END, log);
    } catch (NativeScriptException& e) {
        e.ReThrowToV8();
    } catch (std::exception e) {
        std::stringstream ss;
