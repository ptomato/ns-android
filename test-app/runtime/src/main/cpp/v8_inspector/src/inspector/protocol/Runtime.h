...
public:
    ...
    bool hasMaxDepth() { return m_maxDepth.isJust(); }
    int getMaxDepth(int defaultValue) { return m_maxDepth.isJust() ? m_maxDepth.fromJust() : defaultValue; }
    ...
    public:
        ...
        SerializationOptionsBuilder<STATE>& setMaxDepth(int value)
        {
...
public:
    ...
    bool hasWeakLocalObjectReference() { return m_weakLocalObjectReference.isJust(); }
    int getWeakLocalObjectReference(int defaultValue) { return m_weakLocalObjectReference.isJust() ? m_weakLocalObjectReference.fromJust() : defaultValue; }
    ...
    public:
        ...
        DeepSerializedValueBuilder<STATE>& setValue(std::unique_ptr<protocol::Value> value)
        {
            m_result->setValue(std::move(value));
            return *this;
        }

        DeepSerializedValueBuilder<STATE>& setObjectId(const String& value)
        {
            m_result->setObjectId(value);
            return *this;
        }

        DeepSerializedValueBuilder<STATE>& setWeakLocalObjectReference(int value)
        {
...
public:
    ...
    protocol::Runtime::DeepSerializedValue* getWebDriverValue(protocol::Runtime::DeepSerializedValue* defaultValue) { return m_webDriverValue.isJust() ? m_webDriverValue.fromJust() : defaultValue; }
    void setWebDriverValue(std::unique_ptr<protocol::Runtime::DeepSerializedValue> value) { m_webDriverValue = std::move(value); }

    bool hasDeepSerializedValue() { return m_deepSerializedValue.isJust(); }
    protocol::Runtime::DeepSerializedValue* getDeepSerializedValue(protocol::Runtime::DeepSerializedValue* defaultValue) { return m_deepSerializedValue.isJust() ? m_deepSerializedValue.fromJust() : defaultValue; }
    ...
    public:
        ...
        RemoteObjectBuilder<STATE>& setWebDriverValue(std::unique_ptr<protocol::Runtime::DeepSerializedValue> value)
        {
            m_result->setWebDriverValue(std::move(value));
            return *this;
        }

        RemoteObjectBuilder<STATE>& setDeepSerializedValue(std::unique_ptr<protocol::Runtime::DeepSerializedValue> value)
        {
...
private:
    ...
    Maybe<protocol::Runtime::DeepSerializedValue> m_webDriverValue;
    Maybe<protocol::Runtime::DeepSerializedValue> m_deepSerializedValue;
    Maybe<String> m_objectId;
